...
static void InitDefaultsscc_info_HttpRequest_http_5fgateway_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_HttpRequest_http_5fgateway_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_HttpRequest_http_5fgateway_2eproto}, {}};

static void InitDefaultsscc_info_HttpResponse_http_5fgateway_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_HttpResponse_http_5fgateway_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_HttpResponse_http_5fgateway_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_http_5fgateway_2eproto[2];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_http_5fgateway_2eproto = nullptr;
static const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* file_level_service_descriptors_http_5fgateway_2eproto[1];

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_http_5fgateway_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::_HttpRequest_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::_HttpResponse_default_instance_),
};

const char descriptor_table_protodef_http_5fgateway_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\022http_gateway.proto\"\r\n\013HttpRequest\"\016\n\014H"
  "ttpResponse22\n\013HttpService\022#\n\004Echo\022\014.Htt"
  "pRequest\032\r.HttpResponseB\003\200\001\001"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_http_5fgateway_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_http_5fgateway_2eproto_sccs[2] = {
  &scc_info_HttpRequest_http_5fgateway_2eproto.base,
  &scc_info_HttpResponse_http_5fgateway_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_http_5fgateway_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_http_5fgateway_2eproto = {
  false, false, descriptor_table_protodef_http_5fgateway_2eproto, "http_gateway.proto", 108,
  &descriptor_table_http_5fgateway_2eproto_once, descriptor_table_http_5fgateway_2eproto_sccs, descriptor_table_http_5fgateway_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_http_5fgateway_2eproto::offsets,
  file_level_metadata_http_5fgateway_2eproto, 2, file_level_enum_descriptors_http_5fgateway_2eproto, file_level_service_descriptors_http_5fgateway_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_http_5fgateway_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_http_5fgateway_2eproto)), true);
...
const HttpRequest& HttpRequest::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_HttpRequest_http_5fgateway_2eproto.base);
...
const HttpResponse& HttpResponse::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_HttpResponse_http_5fgateway_2eproto.base);
  return *internal_default_instance();
}
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* HttpService::descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_http_5fgateway_2eproto);
  return file_level_service_descriptors_http_5fgateway_2eproto[0];
}
...
void HttpService::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
                             ...
                             ::google::protobuf::Closure* done) {
  GOOGLE_DCHECK_EQ(method->service(), file_level_service_descriptors_http_5fgateway_2eproto[0]);
  switch(method->index()) {
    case 0:
      Echo(controller,
...
template<> PROTOBUF_NOINLINE ::HttpRequest* Arena::CreateMaybeMessage< ::HttpRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::HttpRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::HttpResponse* Arena::CreateMaybeMessage< ::HttpResponse >(Arena* arena) {
